...
from database.tables import DISCOUNT_TABLE,DISCOUNT_LOCATION,DISCOUNT_DISTRIBUTION_CHANNEL,DISCOUNT_PRIORITY,DISCOUNT_CURRENCY,DISCOUNT_TRANSPORATION_ZONE,DISCOUNT_UOM
from database.fields import Discount_Table,Discount_Location,Discount_Distribution_Channel,Discount_Priority,Discount_Currency,Discount_Transportation_Zone,Discount_UOM
